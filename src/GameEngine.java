...
public class GameEngine {
    ...
    Player objPlayer = new Player("Edward Elric");
    ...
    private void aksi() {
        ...
        if (pil==3) {
            ...
            objRuangan.pilihanAksi(); //aksi ruangan
        } else if (pil==2) {
            objPlayer.pilihanAksi();  //aksi player
        }
    }

    public void mulai() {
        System.out.println("Misi: Player harus keluar ruangan");
